...
public class GameListController {
	...
	// Service method was implemented in 'GameService', but the projected endpoint relates to game lists
	// Therefore this operations must be in the GameList controller not Game
